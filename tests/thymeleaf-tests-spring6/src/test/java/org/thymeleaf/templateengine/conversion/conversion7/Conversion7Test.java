...
public class Conversion7Test {



    public Conversion7Test() {
        super();
    }
    ...
    public void testConversion() throws Exception {
        ...
        final TestExecutor executor = TestExecutorFactory.createTestExecutor(new Conversion7WebProcessingContextBuilder());
        executor.setDialects(Arrays.asList(new IDialect[]{SpringStandardDialectUtils.createSpringStandardDialectInstance()}));

        executor.execute("classpath:templateengine/conversion/conversion7");
