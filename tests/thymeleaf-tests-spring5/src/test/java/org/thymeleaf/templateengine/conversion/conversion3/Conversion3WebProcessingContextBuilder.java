...
public class Conversion3WebProcessingContextBuilder extends SpringMVCWebProcessingContextBuilder {



    public Conversion3WebProcessingContextBuilder() {
        super();
        setApplicationContextConfigLocation("classpath:templateengine/conversion/conversion3/applicationContext.xml");
    }
