...
public class Parsing02Test {


    public Parsing02Test() {
        super();
    }
    ...
    public void testParsing() throws Exception {
        ...
        final String expected = 
                ResourceUtils.read(
                        ClassLoaderUtils.getClassLoader(Parsing02Test.class).getResourceAsStream("parsing/parsingtest02-result.bulk"),
                        "ISO-8859-1",
                        true);
