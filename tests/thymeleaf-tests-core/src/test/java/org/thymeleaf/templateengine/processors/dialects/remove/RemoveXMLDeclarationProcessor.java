...
public class RemoveXMLDeclarationProcessor extends AbstractXMLDeclarationProcessor {

    private static final int PRECEDENCE = 1000;


    public RemoveXMLDeclarationProcessor() {
    ...
    protected void doProcess(
        ...
        structureHandler.removeXMLDeclaration();
