...
public class ReplaceWithProcessableXMLDeclarationProcessor extends AbstractXMLDeclarationProcessor {

    private static final int PRECEDENCE = 1000;


    public ReplaceWithProcessableXMLDeclarationProcessor() {
