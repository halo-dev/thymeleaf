...
public class Attr2ModelAttributeTagProcessor extends AbstractAttributeModelProcessor {
    ...
    public Attr2ModelAttributeTagProcessor(final String dialectPrefix) {
        super(TemplateMode.HTML, dialectPrefix, null, false, "attr2model", true, 50, true);
    }
    ...
    protected void doProcess(final ITemplateContext context, final IModel model, final AttributeName attributeName, final String attributeValue, final IElementModelStructureHandler structureHandler) {
        ...
        final IProcessableElementTag newFirstEvent =
                modelFactory.setAttribute(firstEvent, "var2", (String)context.getVariable("var"));
