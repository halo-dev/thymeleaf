...
public class ReplaceWithNonProcessableCDATASectionProcessor extends AbstractCDATASectionProcessor {

    private static final int PRECEDENCE = 1000;


    public ReplaceWithNonProcessableCDATASectionProcessor() {
