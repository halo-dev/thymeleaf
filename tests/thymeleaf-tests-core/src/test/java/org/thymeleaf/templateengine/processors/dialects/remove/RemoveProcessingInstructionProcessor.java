...
public class RemoveProcessingInstructionProcessor extends AbstractProcessingInstructionProcessor {

    private static final int PRECEDENCE = 1000;


    public RemoveProcessingInstructionProcessor() {
    ...
    protected void doProcess(
        ...
        structureHandler.removeProcessingInstruction();
