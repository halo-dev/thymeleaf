...
public class ReplaceWithNonProcessableProcessingInstructionProcessor extends AbstractProcessingInstructionProcessor {

    private static final int PRECEDENCE = 1000;


    public ReplaceWithNonProcessableProcessingInstructionProcessor() {
