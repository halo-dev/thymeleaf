...
public final class ParserLevelCommentMarkupReaderTest {
    ...
    public void test02() throws Exception {
        ...
        testMessage("<!--/* hello //*/--> */-->", " */-->");
        testMessage("<!--/ hello //*/--> */-->", "<!--/ hello //*/--> */-->");
        testMessage("<!--/<!--/* hello */-->aa", "<!--/aa");
        testMessage("<!--/<!--/* hello */-->aa", "<!--/aa");
        testMessage("<!--/*/ hello /*/--> */-->", " */-->");
        testMessage("<!--/*/ hello /*/--> */--> -->", " */--> -->");
        testMessage("<!--/*/ hello /*/--> */--> <!--/* */--*/-->a", " */--> a");
        testMessage("<!--/*/ hello /*/--> */--> <!--/* */-->-->", " */--> -->");
        testMessage("<!--/*/ hello /*/--> */--> <!--/* */-->", " */--> ");
        testMessage("<<<<!--/*/ hello /*/--> */--> <!--/* */-->", "<<< */--> ");
        testMessage("aa <!-- hello -->", "aa <!-- hello -->");
        testMessage("aa <!-- <!--/* hello /*/--> -->", "aa <!--  -->");
        testMessage("aa <!-- <!--/* hello /*/--> */-->", "aa <!--  */-->");
        testMessage("aa <!-- <!--/* hello /*/--> */--> -->", "aa <!--  */--> -->");
        testMessage("aa <!-- <!--/*/ hello /*/--> */--> -->", "aa <!--  */--> -->");
        testMessage("aa <!-- <!--/*/ hello /*/--> */--> <!--/* */-->-->", "aa <!--  */--> -->");
        ...
        testMessage("aa <!--/* hello //*/--> */-->", "aa  */-->");
        testMessage("aa <!--/ hello //*/--> */-->", "aa <!--/ hello //*/--> */-->");
        testMessage("aa <!--/<!--/* hello */-->aa", "aa <!--/aa");
        testMessage("aa <!--/<!--/* hello */-->aa", "aa <!--/aa");
        testMessage("aa <!--/*/ hello /*/--> */-->", "aa  */-->");
        testMessage("aa <!--/*/ hello /*/--> */--> -->", "aa  */--> -->");
        testMessage("aa <!--/*/ hello /*/--> */--> <!--/* */--*/-->a", "aa  */--> a");
        testMessage("aa <!--/*/ hello /*/--> */--> <!--/* */-->-->", "aa  */--> -->");
        testMessage("aa <!--/*/ hello /*/--> */--> <!--/* */-->", "aa  */--> ");
        testMessage("aa <<<<!--/*/ hello /*/--> */--> <!--/* */-->", "aa <<< */--> ");
            ...
            for (int k = 1; k <= j; k++) {
                ...
                for (int l = 0; l < k; l++) {
                    ...
                    final Reader stringReader =
                            new ParserLevelCommentMarkupReader(new StringReader(message));
