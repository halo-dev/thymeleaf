...
public class DefaultExceptionMessagePatternTestFieldEvaluator extends AbstractStandardTestFieldEvaluator {

    
    public static final DefaultExceptionMessagePatternTestFieldEvaluator INSTANCE = 
            new DefaultExceptionMessagePatternTestFieldEvaluator();
    
    
    private DefaultExceptionMessagePatternTestFieldEvaluator() {
        super(String.class);
    }
