...
public final class TestContext implements ITestContext {
    ...
    private Map<String,ITestContextExpression> applicationAttributes = new LinkedHashMap<String, ITestContextExpression>();
    ...
    public ITestContext aggregate(final ITestContext context) {
        ...
        newContext.getApplicationAttributes().putAll(this.applicationAttributes);
        ...
        if (context != null) {
            ...
            final Map<String,ITestContextExpression> contextApplicationAttributes = context.getApplicationAttributes();
            if (contextApplicationAttributes != null) {
                mergeMaps(newContext.getApplicationAttributes(),contextApplicationAttributes);
            }
